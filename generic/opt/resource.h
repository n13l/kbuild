...
struct resource *res_alloc(const struct res_class *rc) _malloc;
...
void *res_malloc(size_t size, struct resource **ptr) _malloc;
void *res_malloc_zero(size_t size, struct resource **ptr) _malloc;
