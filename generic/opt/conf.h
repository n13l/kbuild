 ...
 **/
#define CF_STATIC(n,p,T,t,c)	{ .cls = CC_STATIC, .type = CT_##T, .name = n, .number = c, .ptr = _check_ptr_type(p,t*) }
/**
 ...
 **/
#define CF_DYNAMIC(n,p,T,t,c)	{ .cls = CC_DYNAMIC, .type = CT_##T, .name = n, .number = c, .ptr = _check_ptr_type(p,t**) }
...
#define CF_LIST(n,p,s)		{ .cls = CC_LIST, .name = n, .number = 1, .ptr = __check_ptr_type(p, struct list*), .u.sec = s }				/** A list with sub-items. **/
#define CF_BITMAP_INT(n,p)	{ .cls = CC_BITMAP, .type = CT_INT, .name = n, .number = 1, .ptr = _check_ptr_type(p,u32*) }			/** A bitmap. **/
#define CF_BITMAP_LOOKUP(n,p,t)	{ .cls = CC_BITMAP, .type = CT_LOOKUP, .name = n, .number = 1, .ptr = _check_ptr_type(p,u32*), .u.lookup = t }	/** A bitmap with named bits. **/
/***
 ...
 **/
#define CF_LOOKUP(n,p,t)	{ .cls = CC_STATIC, .type = CT_LOOKUP, .name = n, .number = 1, .ptr = _check_ptr_type(p,int*), .u.lookup = t }
/**
 * Static array of strings out of predefined set.
 **/
#define CF_LOOKUP_ARY(n,p,t,c)	{ .cls = CC_STATIC, .type = CT_LOOKUP, .name = n, .number = c, .ptr = _check_ptr_type(p,int*), .u.lookup = t }
/**
 * Dynamic array of strings out of predefined set.
 **/
#define CF_LOOKUP_DYN(n,p,t,c)	{ .cls = CC_DYNAMIC, .type = CT_LOOKUP, .name = n, .number = c, .ptr = _check_ptr_type(p,int**), .u.lookup = t }
/**
 * A user-defined type.
...
char *cf_printf(const char *fmt, ...) _format_check(printf,1,2); /** printf() into @cf_malloc()ed memory. **/
